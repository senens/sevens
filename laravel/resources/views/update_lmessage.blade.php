            ...
            <div class="article">
                <div class="content" style="clear: both">
                    <div class="content-1" style="line-height:26px;"><div class="content-1">
                            ...
                            @foreach($valls as $vv)
                                <form action={{URL('tenant/finish_lup')}}?id={{$vv->u_id}}" method='post' enctype="multipart/form-data">
                                    <input type="hidden" name="_token"    value="<?php echo csrf_token() ?>"/>
                                <tr>
                                    <h4>用户头像</h4>
                                </tr>
                                <tr >
                                    <h4><img src="{{URL::asset('../public/uploads')}}/{{$vv->u_header_url}}" width="111px" height="111px"/></h4>
                                    <input type="file" name="myfile"/>
                                </tr>
                                <tr>
                                    <td><h4><font color="#00ced1"> 昵称：</font><input type="text" name="nickname" value="{{$vv->u_nickname}} "/><br /></h4></td>
                                </tr>
                                <tr>
                                    <td><h4><font color="#00ced1">性别：</font><input type="text" name="sex" value="{{$vv->u_sex}} "/><br /></h4></td>
                                </tr>
                                <tr>
                                    <td><h4><font color="#00ced1">电话：</font><input type="text" name="phone" value="{{$vv->u_phone}}"/>  <br /></h4></td>
                                </tr>
                                <tr>
                                    <td> <h4><font color="#00ced1">email：</font><input type="text" name="u_email" value="{{$vv->u_email}} "/> <br /></h4></td>
                                </tr>
                                <tr>
                                    <td> <h4><font color="#00ced1">地址：</font><input type="text" name="u_email" value="{{$vv->u_address}} "/> <br /></h4></td>
                                </tr>
