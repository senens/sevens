	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="index.php?r=account/edited" method="post"  onsubmit ="return froms()">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="user" name="username" onblur="usernames()" value="<?=$v['u_name']?>"  class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" id="pwdd" onblur="passwords()" name="pwd" value="<?=$v['u_pawd']?>"  class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php 
								if($v['u_sex'] == 0){
										echo "
							<input type='radio' id='form-field-1' checked name='sex' value='0' />男
							<input type='radio' id='form-field-1' name='sex' value='1' />女";
								}elseif($v['u_sex'] == 1){
									echo "
							<input type='radio' id='form-field-1' name='sex' value='0' />男
							<input type='radio' id='form-field-1'  checked name='sex' value='1' />女";
								 }?>
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							&nbsp; &nbsp; &nbsp;
								...
								<input type="hidden" name="upId" value="<?=$v['u_id']?>">
