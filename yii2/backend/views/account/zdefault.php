	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="index.php?r=account/zeditd" method="post"  onsubmit ="return froms()">
					<?php 
						foreach ($data as $k => $v) {?>
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 租客姓名： </label>
...
var res;
	function usernames(){
		var name = $('#user').val();
		if(name == ""){
			$('#sp1').attr('style',"color:red").html("&nbsp;&nbsp;&nbsp;请输入租客姓名");
			return false;
		}else{
			var data = {'name':name};
			...
			$.get(url,data,function(msg){
				if(msg == 1){
					$('#sp1').attr('style',"color:red").html("&nbsp;&nbsp;&nbsp;租客账号已存在！！！");
					res = false;
				}else{
					$('#sp1').attr('style',"color:green").html("&nbsp;&nbsp;&nbsp;租客账号可用");
					res = true;
				}
			})
		}
